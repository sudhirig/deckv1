...
<div class="grid grid-cols-2 gap-8 h-[75vh]">
  <div class="space-y-4">
    ...
    <div class="space-y-3">
      ...
      <div class="p-4 bg-gradient-to-r from-purple-900/40 to-pink-900/40 rounded-lg border border-purple-500/30">
        <div class="font-semibold text-purple-300 mb-2">Always Working For You</div>
        <div class="text-sm text-gray-400 space-y-1">
  ...
  <div class="relative p-4 border-2 border-teal-500 rounded-xl bg-black/40">
    <div class="text-sm font-semibold text-teal-400 mb-3">Premium Platform Preview</div>
    <img src="/Screenshot 2025-11-04 at 19.24.38.png" class="rounded-lg w-full mb-3" alt="Platform Dashboard" />
    <img src="/Screenshot 2025-11-04 at 19.31.26.png" class="rounded-lg w-full mb-3" alt="AI Committee" />
    <img src="/Screenshot 2025-11-04 at 19.31.57.png" class="rounded-lg w-full" alt="Execution Engine" />
    <div class="absolute top-4 right-4 px-3 py-1 bg-green-500/20 border border-green-500 rounded-full text-xs font-semibold text-green-400">
  ...
  <div class="space-y-4">
    ...
    <div class="p-4 bg-gradient-to-r from-blue-900/40 to-cyan-900/40 rounded-lg border border-blue-500/30">
      ...
      <div class="grid grid-cols-2 gap-2 text-xs">
        ...
        <div class="p-2 bg-blue-900/30 rounded">PostgreSQL (dual DBs)</div>
        <div class="p-2 bg-blue-900/30 rounded">FastAPI ML services</div>
        <div class="p-2 bg-blue-900/30 rounded">LangGraph orchestration</div>
        <div class="p-2 bg-blue-900/30 rounded">Multi-LLM ensemble</div>
      </div>
    </div>
...
<div class="space-y-12 max-w-4xl mx-auto px-8">
  ...
  <div class="grid grid-cols-3 gap-8 text-sm mt-12">
    <div>
